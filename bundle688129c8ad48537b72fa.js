...
var showScores = function showScores(_ref) {
  var user = _ref.user,
    score = _ref.score;
...
/* harmony import */ var _ValidateForm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ValidateForm.js */ "./src/modules/ValidateForm.js");
...
var myScores = document.getElementById('scores-display');
var MY_ID = 'MCFVpRFD1Przw09OSrOE';
var retrieveScores = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _final, outcome, points;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/".concat(MY_ID, "/scores/"));
        case 3:
        ...
        case 9:
          ...
          points.forEach(function (point) {
            myScores.append((0,_DisplayScore_js__WEBPACK_IMPORTED_MODULE_0__["default"])(point));
          });
  ...
  return function retrieveScores() {
    return _ref.apply(this, arguments);
  };
}();
var addScore = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(updatedScore) {
    var _final2, outcome;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          (0,_ValidateForm_js__WEBPACK_IMPORTED_MODULE_1__["default"])(outcome.message);
          return _context2.abrupt("return", outcome);
        case 10:
          retrieveScores();
          (0,_ValidateForm_js__WEBPACK_IMPORTED_MODULE_1__["default"])(outcome.result);
          return _context2.abrupt("return", outcome);
        case 15:
          _context2.prev = 15;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var formField = document.getElementById('form-area');
var showMessage = function showMessage(message) {
  var msgContext = document.createElement('small');
  if (message.includes('provide')) {
    msgContext.className = 'errorMsg';
    msgContext.textContent = "".concat(message);
...
/* harmony import */ var _modules_FetchScore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/FetchScore.js */ "./src/modules/FetchScore.js");
...
formField.addEventListener('submit', function (e) {
  ...
  var scoreText = document.getElementById('input-number');
  var updateScore = {
    user: userText.value,
    score: Number(scoreText.value)
  };
  (0,_modules_FetchScore_js__WEBPACK_IMPORTED_MODULE_1__.addScore)(updateScore);
  userText.value = '';
  scoreText.value = '';
});
refresh.addEventListener('click', _modules_FetchScore_js__WEBPACK_IMPORTED_MODULE_1__.retrieveScores);
